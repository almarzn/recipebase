...
<template>
  <Button
    ...
    :class="
      cn(
        'flex items-center justify-stretch gap-2 rounded-full border-2 bg-gray-500/5 text-muted-foreground backdrop-blur-xl max-md:self-stretch md:self-center overflow-hidden',
        $props.class,
      )
    "
