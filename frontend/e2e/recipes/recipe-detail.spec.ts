...
const mockRecipeWithComponents = {
  ...
  yield: { quantity: { type: "decimal", unit: { type: "custom", name: "servings" }, amount: 4 }, description: null },
      ...
      ingredients: [
        {
          ...
          quantity: { type: "decimal", unit: { type: "gram" }, amount: 300 },
          position: 1,
        },
        {
          id: "ing-2",
          ...
          name: "Large eggs",
          notes: null,
          quantity: { type: "decimal", unit: { type: "gram" }, amount: 150 },
          position: 2,
        },
      ],
      steps: [
...
const mockRecipeMultiComponent = {
  ...
  tags: ["italian"],
  source: null,
  yield: { quantity: { type: "decimal", unit: { type: "custom", name: "servings" }, amount: 8 }, description: null },
  createdAt: "2026-01-01T00:00:00Z",
  updatedAt: "2026-01-01T00:00:00Z",
  notes: null,
  components: [
      ...
      ingredients: [
        {
          ...
          name: "Ground beef",
          notes: null,
          quantity: { type: "decimal", unit: { type: "gram" }, amount: 500 },
          position: 1,
        },
      ],
      steps: [
      ...
      ingredients: [
        {
          ...
          name: "Whole milk",
          notes: null,
          quantity: { type: "decimal", unit: { type: "milliliter" }, amount: 1000 },
          position: 1,
        },
      ],
      steps: [
