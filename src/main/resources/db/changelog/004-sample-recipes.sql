...
INSERT INTO recipe (id, item_id, source, yield, notes) VALUES
    ('b1000000-0000-0000-0000-000000000001',
     ...
     '{"type":"original"}',
     '{"quantity":2,"unit":"pizzas","description":"two 30cm pizzas"}',
...
INSERT INTO recipe_ingredient (id, component_id, slug, name, quantity, notes, position) VALUES
    ('d1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000001', 'bread-flour',    'Bread flour',        '{"unit":"gram","amount":500}',  NULL,                  1),
    ('d1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000001', 'water',          'Water',               '{"unit":"milliliter","amount":325}', 'lukewarm',          2),
    ('d1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000001', 'salt',           'Fine sea salt',       '{"unit":"gram","amount":10}',   NULL,                  3),
    ('d1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000001', 'yeast',          'Instant dry yeast',   '{"unit":"gram","amount":3}',    NULL,                  4),
    ('d1000000-0000-0000-0000-000000000005', 'c1000000-0000-0000-0000-000000000001', 'olive-oil',      'Olive oil',           '{"unit":"milliliter","amount":20}',  NULL,              5);
...
INSERT INTO recipe (id, item_id, source, yield, notes) VALUES
    ('b1000000-0000-0000-0000-000000000002',
     ...
     '{"type":"original"}',
     '{"quantity":4,"unit":"servings","description":null}',
...
INSERT INTO recipe_ingredient (id, component_id, slug, name, quantity, notes, position) VALUES
    ('d2000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000002', 'spinach',      'Fresh spinach',        '{"unit":"gram","amount":500}',  'washed',              1),
    ('d2000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000002', 'onion',        'Onion',                '{"unit":"unspecified","notes":"1 large"}', NULL,        2),
    ('d2000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000002', 'garlic',       'Garlic cloves',        '{"unit":"unspecified","notes":"4 cloves"}', NULL,       3),
    ('d2000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000002', 'ginger',       'Fresh ginger',         '{"unit":"gram","amount":20}',   'grated',              4),
    ('d2000000-0000-0000-0000-000000000005', 'c1000000-0000-0000-0000-000000000002', 'green-chili',  'Green chili',          '{"unit":"unspecified","notes":"1-2"}', NULL,            5),
    ('d2000000-0000-0000-0000-000000000006', 'c1000000-0000-0000-0000-000000000002', 'cumin',        'Cumin seeds',          '{"unit":"gram","amount":2}',    NULL,                  6),
    ('d2000000-0000-0000-0000-000000000007', 'c1000000-0000-0000-0000-000000000002', 'cream',        'Heavy cream',          '{"unit":"milliliter","amount":100}',  NULL,            7),
    ('d2000000-0000-0000-0000-000000000008', 'c1000000-0000-0000-0000-000000000002', 'oil',          'Vegetable oil',        '{"unit":"milliliter","amount":30}',   NULL,              8),
    ('d2000000-0000-0000-0000-000000000009', 'c1000000-0000-0000-0000-000000000002', 'garam-masala', 'Garam masala',         '{"unit":"gram","amount":5}',    NULL,                  9),
    ('d2000000-0000-0000-0000-000000000010', 'c1000000-0000-0000-0000-000000000002', 'salt-1',       'Salt',                 '{"unit":"unspecified","notes":"to taste"}', NULL,      10);

--changeset recipebase:004-paneer-spinach-ingredients-paneer
INSERT INTO recipe_ingredient (id, component_id, slug, name, quantity, notes, position) VALUES
    ('d2000000-0000-0000-0000-000000000011', 'c1000000-0000-0000-0000-000000000003', 'paneer',       'Paneer cheese',        '{"unit":"gram","amount":250}',  'cubed',               1);
...
INSERT INTO recipe (id, item_id, source, yield, notes) VALUES
    ('b1000000-0000-0000-0000-000000000003',
     ...
     '{"type":"original"}',
     '{"quantity":1,"unit":"layer","description":"one 20cm round"}',
     NULL);
...
INSERT INTO recipe_ingredient (id, component_id, slug, name, quantity, notes, position) VALUES
    ('d3000000-0000-0000-0000-000000000001', 'c3000000-0000-0000-0000-000000000001', 'eggs',       'Eggs',             '{"unit":"unspecified","notes":"4 large"}',  NULL,   1),
    ('d3000000-0000-0000-0000-000000000002', 'c3000000-0000-0000-0000-000000000001', 'sugar',      'Sugar',            '{"unit":"gram","amount":120}',              NULL,   2),
    ('d3000000-0000-0000-0000-000000000003', 'c3000000-0000-0000-0000-000000000001', 'flour',      'All-purpose flour','{"unit":"gram","amount":120}',              NULL,   3),
    ('d3000000-0000-0000-0000-000000000004', 'c3000000-0000-0000-0000-000000000001', 'butter',     'Melted butter',    '{"unit":"gram","amount":30}',               NULL,   4);
...
INSERT INTO recipe (id, item_id, source, yield, notes) VALUES
    ('b1000000-0000-0000-0000-000000000004',
     ...
     '{"type":"original"}',
     '{"quantity":20,"unit":"pieces","description":"halved strawberries"}',
     NULL);
...
INSERT INTO recipe_ingredient (id, component_id, slug, name, quantity, notes, position) VALUES
    ('d4000000-0000-0000-0000-000000000001', 'c4000000-0000-0000-0000-000000000001', 'strawberries', 'Fresh strawberries', '{"unit":"gram","amount":400}', 'hulled and halved', 1);
...
INSERT INTO recipe (id, item_id, source, yield, notes) VALUES
    ('b1000000-0000-0000-0000-000000000005',
     ...
     '{"type":"original"}',
     '{"quantity":500,"unit":"milliliter","description":"enough for one 20cm cake"}',
     NULL);
...
INSERT INTO recipe_ingredient (id, component_id, slug, name, quantity, notes, position) VALUES
    ('d5000000-0000-0000-0000-000000000001', 'c5000000-0000-0000-0000-000000000001', 'milk',      'Whole milk',       '{"unit":"milliliter","amount":500}',  NULL,            1),
    ('d5000000-0000-0000-0000-000000000002', 'c5000000-0000-0000-0000-000000000001', 'egg-yolks', 'Egg yolks',        '{"unit":"unspecified","notes":"6"}',  NULL,            2),
    ('d5000000-0000-0000-0000-000000000003', 'c5000000-0000-0000-0000-000000000001', 'sugar',     'Sugar',            '{"unit":"gram","amount":150}',        NULL,            3),
    ('d5000000-0000-0000-0000-000000000004', 'c5000000-0000-0000-0000-000000000001', 'cornstarch','Cornstarch',       '{"unit":"gram","amount":40}',         NULL,            4),
    ('d5000000-0000-0000-0000-000000000005', 'c5000000-0000-0000-0000-000000000001', 'butter',    'Unsalted butter',  '{"unit":"gram","amount":150}',        'softened',      5),
    ('d5000000-0000-0000-0000-000000000006', 'c5000000-0000-0000-0000-000000000001', 'vanilla',   'Vanilla extract',  '{"unit":"milliliter","amount":5}',    NULL,            6);
...
INSERT INTO assembly (id, item_id, yield) VALUES
    ('f1000000-0000-0000-0000-000000000001',
     ...
     '{"quantity":8,"unit":"slices","description":"one 20cm cake"}');
